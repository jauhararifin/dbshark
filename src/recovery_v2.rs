...
pub(crate) fn recover(
    ...
    crate::wal_v2::recover(path, |lsn, entry| {
...
impl Analyzer {
    ...
    fn analyze(&mut self, lsn: Lsn, entry: &WalEntry) {
        self.next_lsn = lsn.add(entry.size() as u64);
...
// }
//
// fn undo(analyze_result: &AnalyzeResult, pager: &Pager, wal: &Wal) -> anyhow::Result<()> {
