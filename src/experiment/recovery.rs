use crate::experiment::content::Bytes;
use crate::experiment::id::{Lsn, PageId, TxId};
use crate::experiment::log::{TxState, WalEntry, WalKind};
use crate::experiment::pager::{DbState, LogContext, PageOps, PageWriteOps, Pager};
use crate::experiment::runtime::Runtime;
...
pub(crate) fn recover<R: Runtime>(
    ...
    let wal = crate::experiment::wal::recover(path, |lsn, entry| {
